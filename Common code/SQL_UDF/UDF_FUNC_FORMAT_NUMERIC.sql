IF object_id('[dbo].[UDF_FUNC_FORMAT_NUMERIC]') is not NULL
BEGIN
   DROP FUNCTION [dbo].[UDF_FUNC_FORMAT_NUMERIC]
END

GO

CREATE FUNCTION [dbo].[UDF_FUNC_FORMAT_NUMERIC] (
...
set @return_value = ltrim(str(isnull(@NUMERIC, 0), 40, @rounding))
